...
class Bank {
    ...
    static isAccountNumberValid(bankId, bankNumber, branchNumber, accountNumber, suffix) {
        ...
        let bankNumberInstance = bank.getBankNumber(bankNumber);
        if (bankNumberInstance) {
            let formattedBankAccount = this.getFormattedBankAccount(bankNumber, branchNumber, accountNumber, suffix);
    ...
    static getBank(bankId) {
        let banks = this.values.filter(x => x.bankId === bankId);
        let bank = undefined;
...
Bank.Westpac = new Bank(9, "Westpac", [bankNumber_1.BankNumber.three, bankNumber_1.BankNumber.thirteen,
    bankNumber_1.BankNumber.fourteen, bankNumber_1.BankNumber.sixteen, bankNumber_1.BankNumber.seventeen, bankNumber_1.BankNumber.eighteen, bankNumber_1.BankNumber.nineteen, bankNumber_1.BankNumber.twenty,
    bankNumber_1.BankNumber.twentyOne, bankNumber_1.BankNumber.twentyTwo, bankNumber_1.BankNumber.twentyThree, bankNumber_1.BankNumber.twentySeven]);
Bank.Other = new Bank(10, "Other", [bankNumber_1.BankNumber.one, bankNumber_1.BankNumber.two, bankNumber_1.BankNumber.three, bankNumber_1.BankNumber.four, bankNumber_1.BankNumber.six,
    bankNumber_1.BankNumber.eight, bankNumber_1.BankNumber.nine, bankNumber_1.BankNumber.ten, bankNumber_1.BankNumber.eleven, bankNumber_1.BankNumber.twelve, bankNumber_1.BankNumber.thirteen, bankNumber_1.BankNumber.fourteen,
    bankNumber_1.BankNumber.fifteen, bankNumber_1.BankNumber.sixteen, bankNumber_1.BankNumber.seventeen, bankNumber_1.BankNumber.eighteen, bankNumber_1.BankNumber.nineteen, bankNumber_1.BankNumber.twenty,
    bankNumber_1.BankNumber.twentyOne, bankNumber_1.BankNumber.twentyTwo, bankNumber_1.BankNumber.twentyThree, bankNumber_1.BankNumber.twentyFour, bankNumber_1.BankNumber.twentyFive,
    bankNumber_1.BankNumber.twentySix, bankNumber_1.BankNumber.twentySeven, bankNumber_1.BankNumber.twentyEight, bankNumber_1.BankNumber.twentyNine, bankNumber_1.BankNumber.thirty,
    bankNumber_1.BankNumber.thirtyOne, bankNumber_1.BankNumber.thirtyThree, bankNumber_1.BankNumber.thirtyFive, bankNumber_1.BankNumber.thirtyEight]);
exports.Bank = Bank;
